...
//importing dashboard section components.
...
function EmployeeDashboard() {
  //state to track which dashboard section in active
  const [activeSection, setActiveSection] = useState("personal");
  //useNavigate hook allows redirection
  ...
  //function to return component based on selected section.
  const renderContent = () => {
